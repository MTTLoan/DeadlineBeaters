...
public class HoaDonPhatForm extends javax.swing.JPanel {
    ...
    public final void initTable() {
        ...
        String[] headerTbl = new String[]{"Mã hóa đơn phạt", "Mã xe", "Loại phạt", "Số tiền", "Chú thích", "Hình ảnh"};
        ...
        try {
            ...
            for (ChiTietHDPhat i : hd) {
                ...
                tblModel.addRow(new Object[]{
                    i.getMaHDP(), i.getMaXe(), i.getLoaiPhat(), i.getSoTien(), i.getChuThich(), i.getHinhAnh()
                });
            }
        } catch (Exception e) {
            e.printStackTrace();
