...
public class HoaDonPhatForm extends javax.swing.JPanel {
    ...
    private void jButton_XoaHDPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_XoaHDPActionPerformed
        // TODO add your handling code here:
        if (jTable_CTHDPhat.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn hóa đơn phạt muốn xoá");
        } else {
            int output = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xoá hóa đơn phạt", "Xác nhận xoá hóa đơn phạt", JOptionPane.YES_NO_OPTION);
            if (output == JOptionPane.YES_OPTION) {
                ChiTietHDPhatDAO.getInstance().delete(getCTHDPhatSelect());
                JOptionPane.showMessageDialog(this, "Xóa thành công hóa đơn phạt!");
                loadDataToTable(ChiTietHDPhatDAO.getInstance().selectAll());
            }
        }
    ...
    private void jButton_SuaHDPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SuaHDPActionPerformed
        // TODO add your handling code here:
        if (jTable_CTHDPhat.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn hóa đơn phạt muốn sửa");
        } else {
            SuaCTHDPhat a = new SuaCTHDPhat(getCTHDPhatSelect());
            a.setVisible(true);
        }
